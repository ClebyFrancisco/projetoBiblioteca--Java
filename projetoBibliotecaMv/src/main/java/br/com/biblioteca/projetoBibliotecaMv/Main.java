...
public class Main {
	public static void main(String[] args) {
		...
		// criando exemplares
		Exemplar.dataExemplares.put("livro1", new Exemplar(Autor.dataAutores.get("Ciclano"), "livro1", "2018", 4, "edit", "54719", 1, 142, 29.90));
		Exemplar.dataExemplares.put("livro2", new Exemplar(Autor.dataAutores.get("Beltrano"), "livro2", "2018", 4, "edit", "54719", 1, 172, 50));
		Exemplar.dataExemplares.put("livro3", new Exemplar(Autor.dataAutores.get("Deltrano"), "livro3", "2018", 4, "edit", "54719", 1, 187, 20));
		Exemplar.dataExemplares.put("livro4", new Exemplar(Autor.dataAutores.get("Elano"), "livro4", "2018", 4, "edit", "54719", 2, 17872, 190.5));
		Exemplar.dataExemplares.put("livro5", new Exemplar(Autor.dataAutores.get("Fulano"), "livro5", "2018", 4, "edit", "54719", 1, 1782, 500.5));
		...
		// PEGAR LIVRO EMPRESTADO
			...
			if (Usuario.dataUsuarios.containsKey(cpf)) {
				...
				if (Exemplar.dataExemplares.get(exemplar).getQtdd() > 0) {
					Emprestimo emp = new Emprestimo(Usuario.dataUsuarios.get(cpf), Exemplar.dataExemplares.get(exemplar));
		...
		// COMPRAR LIVRO
			...
			if (Usuario.dataUsuarios.containsKey(cpf)) {
				...
				Compra comp = new Compra(Usuario.dataUsuarios.get(cpf), Exemplar.dataExemplares.get(exemplar));
